...
Use exactly the expected keys: extracted.date, extracted.weightKg, extracted.skeletalMuscleKg, extracted.bodyFatPercent, extracted.fatMassKg, extracted.bodyWaterKg, extracted.bmi, extracted.bmrCalories, extracted.visibleNotes, coach.bodySummary, coach.runnerInterpretation, coach.nutritionFocus, coach.strengthFocus, coach.cautionNotes, coach.coachNote.
`;
