...
import { FitbitConnectSection } from "@/components/settings/FitbitConnectSection";
        ...
        <div className="space-y-4">
          <section className="card space-y-3 p-5">
            <div>
              ...
              <h2 className="mt-1 text-xl font-bold text-[var(--foreground)]">จากประวัติของคุณ</h2>
