  ...
  return (
    <div className="mx-auto flex min-h-screen w-full max-w-md flex-col px-4 pb-[calc(8rem+env(safe-area-inset-bottom))] pt-[calc(1.25rem+env(safe-area-inset-top))]">
      <header className="mb-4 flex items-start justify-between gap-3">
        <GuardedLink href="/" className="min-w-0">
        ...
        <GuardedLink href="/settings" aria-label="ตั้งค่า" className="grid h-9 w-9 shrink-0 place-items-center rounded-full border border-[var(--border-warm)]/70 bg-[var(--surface)]/85 text-[var(--muted-text)] shadow-sm hover:text-[var(--primary-strong)]">
