        ...
        <div className="flex gap-2">
          {routines.map((r) => (
            <button
              ...
              className={`flex-1 rounded-xl py-2 px-1 text-xs font-bold border transition-colors ${selectedRoutine?.id === r.id ? "border-[var(--primary)] bg-[var(--primary)] text-[#f5f8ff]" : "border-[var(--border-warm)] text-[var(--color-text-muted)] bg-[var(--surface)]"}`}
            >
